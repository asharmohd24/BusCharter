  ...
  pages: {
    home: {
      seo: {
        ...
        description: "Reliable charter bus services for corporate events, weddings, and group travel. Explore our modern fleet of mini-buses, coaches, and party buses. Get a quote today.",
        keywords: "charter bus rental, group transportation, bus charter services, corporate event transportation, wedding shuttle service, party bus rental, mini bus hire, coach rental for groups, airport shuttle service, school trip transportation",
      },
      hero: {
        tag: "CHARTER THE BEST",
        titleHighlight: "Travel",
        titleMain: "Together.",
        titleUnderline: "Arrive",
        titleEnd: "in Style.",
        text: "Whether you're planning a corporate retreat, wedding celebration, or school trip, we've got you covered. From luxury coaches to reliable minibuses, our charter service is built for comfort, safety, and convenience. Book your group transportation in just a few clicks — no hassle, no worries.",
        primaryBtnText: "Book Now",
        primaryBtnLink: "/booking",
        secondaryBtnText: "View Our Fleets",
        secondaryBtnLink: "/our-fleet",
        image: "/assets/images/herobus.png",
        imageAlt: "Hero Vehicle",
      },
      servicesSection: {
        tag: "WHAT WE OFFER",
      ...
      faqSection: {
        ...
        subtitle: "Find answers to common questions about our rental process, repair services, payments, and more.",
        items: [
          {
            id: 1,
            question: "How do I book a bus charter?",
            answer: "You can book a bus through our website by selecting your trip details, dates, group size, and preferred vehicle type.",
          },
          {
            id: 2,
            question: "What types of buses do you offer?",
            answer: "We offer a range of vehicles including luxury coaches, minibuses, party buses, and school buses to accommodate groups of all sizes.",
          },
          {
            id: 3,
            question: "How far in advance should I book?",
            answer: "We recommend booking 2-4 weeks in advance for most trips, and 3-6 months for weddings and large events.",
          },
        ],
      },
      testimonialsSection: {
      ...
      ctaSection: {
        ...
        titleMiddle: "Your Bus or Get a",
        titleHighlight2: "Quote",
        titleEnd: "in Minutes",
        text: "Quick bookings, reliable service, and a fleet you can trust.",
        primaryBtnText: "Get a Quote",
        primaryBtnLink: "/booking",
        secondaryBtnText: "View Our Fleet",
        secondaryBtnLink: "/our-fleet",
        image: "/assets/images/cta.png",
        imageAlt: "Luxury coach bus ready for your group",
      },
      brandsSection: {
        tag: "OUR PARTNERS",
    ...
    about: {
      ...
      aboutImage: "/assets/images/abtus1.png",
      aboutImageAlt: "About Us",
      extraDescription: "We pride ourselves on delivering exceptional customer service and maintaining a fleet of well-maintained, reliable vehicles. Whether you need a bus for business, pleasure, or everyday use, we have the perfect solution for you.",
      ...
      ctaText: "Contact us today to learn more about how we can help you.",
      ctaBtnText: "Book Now",
      ctaBtnLink: "/booking",
    },
    services: {
      ...
      tag: "What We Offer",
      title: "Premium Charter Services For You",
      subtitle: "We offer a comprehensive range of bus transportation services to meet all your needs.",
      processTag: "Our Process",
      processTitle: "How We Work",
      ctaTitle: "Ready to Book Your Bus?",
      ctaText: "Contact us today for a free quote on group transportation.",
    ...
    ourFleet: {
      ...
      resultsTitle: "Choose Your Perfect Coach",
      ctaTitle: "Not Sure Which Bus to Choose?",
      ctaText: "Our team will help you find the perfect vehicle for your group size and needs.",
      ctaPrimaryBtnText: "Contact Us",
      ctaPrimaryBtnLink: "/contact",
      ctaSecondaryBtnText: "Get a Quote",
      ctaSecondaryBtnLink: "/booking",
    },
    blogs: {
      seo: {
      ...
      bannerTitle: "Global Bus Charter Blog",
      tag: "Our Blog",
      title: "Latest News & Travel Tips",
      subtitle: "Stay informed with our latest articles on group travel, bus charter tips, and industry insights.",
      searchPlaceholder: "Search articles...",
      noResultsTitle: "No articles found",
      noResultsText: "Try adjusting your search or filter to find what you're looking for.",
      noResultsBtnText: "View All Articles",
    },
    contact: {
      seo: {
        title: "Contact Us",
        description: "Get in touch with Global Bus Charter. Call us or email us to book your group transportation today.",
      ...
      formSection: {
        ...
        subtitle: "Have a question or need assistance? Fill out the form below and we'll get back to you as soon as possible.",
        fields: {
        ...
        noCountriesText: "No countries found",
    ...
    booking: {
      ...
      bannerTitle: "Book Your Ride",
      formHeader: {
        title: "Book Your Transportation",
        subtitle: "Fill in the details below to request a booking",
      },
      tabs: {
        oneWay: "One Way",
      ...
      fields: {
        pickupLocation: { label: "Pickup Location *", placeholder: "Enter pickup address" },
        dropoffLocation: { label: "Drop-off Location *", placeholder: "Enter drop-off address" },
        pickupDate: { label: "Pickup Date *" },
        pickupTime: { label: "Pickup Time *" },
        returnDate: { label: "Return Date *" },
        returnTime: { label: "Return Time *" },
        passengers: { label: "Number of Passengers", placeholder: "Enter number (e.g., 4)" },
        name: { label: "Your Name *", placeholder: "Full name" },
        email: { label: "Email Address *", placeholder: "your@email.com" },
        phone: { label: "Phone Number *", placeholder: "Phone number" },
        notes: { label: "Special Requests", placeholder: "Any special requirements..." },
      },
      submitText: "Request Booking",
      submittingText: "Submitting...",
      configErrorText: "Configuration Error: Google Maps API key is missing.",
      countrySearchPlaceholder: "Search country...",
      noCountriesText: "No countries found",
    },
  },
